...
class _MyAppState extends State<_MyApp> {
  ...
  final _flashOnController = TextEditingController(text: "Flash: OFF");
  final _flashOffController = TextEditingController(text: "Flash: ON");
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void fabPressed() async {
    ...
    try {
      var scans = await BarcodeScanner.scan();
      barcode = Text(scans.rawContent ?? "") as String;
